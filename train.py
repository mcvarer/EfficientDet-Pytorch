...
parser.add_argument(
    '--dataset_root',
    default='/home/mcv/PycharmProjects/EfficientDet.Pytorch/Dataset',
...
parser.add_argument('--device', default=[0, 1], type=list,
                    help='Use CUDA to train2017 model')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if(args.dataset == 'VOC'):
        ...
        valid_dataset = VOCDetection(root=args.dataset_root, image_sets=[(
            '2007', 'test2017')], transform=transforms.Compose([Normalizer(), Resizer()]))
